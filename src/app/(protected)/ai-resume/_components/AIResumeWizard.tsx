...
export type Step = "input" | "ats-dashboard" | "skills-feedback" | "hygiene-template" | "template-preview" | "template-full-view";
...
export function AIResumeWizard() {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto pb-20">
            ...
            {step === "template-preview" && <ResumeTemplatePreviewScreen onNext={() => setStep("template-full-view")} onBack={() => setStep("hygiene-template")} />}
            {step === "template-full-view" && <ResumeTemplateFullViewScreen onBack={() => setStep("template-preview")} file={uploadedFile} />}
        </div>
    );
}
