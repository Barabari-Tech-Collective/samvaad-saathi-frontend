    ...
    const groups = [
        {
            title: "Strong skills",
            count: 4,
            items: ["React", "JavaScript", "Responsive Design", "APIs"],
        ...
        },
        {
            ...
            count: 4,
            items: ["TypeScript", "Unit Testing", "Performance Opt.", "GraphQL"],
        ...
        },
        {
            title: "De-prioritize",
            count: 3,
            items: ["Basic C", "MS Office", "Typing Speed"],
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col gap-4">
                {groups.map((group, i) => (
                    <div key={i} className="p-4 rounded-3xl bg-white border border-slate-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-xs font-semibold text-slate-400">{group.count}</span>
                        </div>
                        
                        <div className="flex flex-wrap gap-2">
                            {group.items.map((item, j) => (
                                <span key={j} className={`px-3 py-1.5 rounded-full text-[13px] font-bold ${group.color}`}>
                                    {item}
                                </span>
                            ))}
                        </div>
